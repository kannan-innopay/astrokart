...
return [
    ...
    */
    ...
    'features' => [
        'astrologers' => env('FEATURE_ASTROLOGERS', false),
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Locales the UI can be displayed in, keyed by code with their native name
    | (used by the language switcher and the SetLocale middleware).
    |
    */
